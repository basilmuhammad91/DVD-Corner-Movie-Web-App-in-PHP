...
// Fetching Detail from news to blog detail oage dynamically
if(isset($_GET['news_id']))
{
	$news_id = $_GET['news_id'];

	$query = mysqli_query($con,"select * from news where id = '$news_id'");
		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="blog-detail-ct">
					<h1><?php echo $std['news_title']?></h1>
					<span class="time"><?php echo $std['date']?></span>
					<img src="data:image/jpeg;base64,<?php echo base64_encode($std['news_cover_image'])?>" alt="">
					<p>
					<?php echo $std['news_description'] ?></p>
