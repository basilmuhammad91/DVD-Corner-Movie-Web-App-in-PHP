...
if(isset($_GET['movie_id']))
{
	...
	$query = mysqli_query($con,"select tbl_movie_id, tbl_movie_title, tbl_movie_image,tbl_movie_trailer_link, year(tbl_movie_release_date), tbl_movie_description FROM tbl_movie where tbl_movie_id  = '$movie_id'");
...
<body>
	...
	<script>
		...
		$(document).ready(function(){
			...
			// THIS IS FOR COMMENT WORK
			$('#comment_form').on('submit', function(event){
				event.preventDefault();
				var form_data = $(this).searialize();
				$.ajax({
					url: "add_comment.php",
					method: "POST",
					data: form_data,
				...
				<div class="movie-img sticky-sb">
					...
					<div class="movie-btn">	
						...
						<div class="btn-transform transform-vertical">
							<div><a href="movieorderpage.php?movie_id=<?php echo $movie_id?>" class="item item-1 yellowbtn"> <i class="ion-card"></i> Buy DVD</a></div>
							<div><a href="movieorderpage.php?movie_id=<?php echo $movie_id?>" class="item item-2 yellowbtn"><i class="ion-card"></i></a></div>
						</div>
					</div>
				</div>
			</div>
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
											...
											<form method="post" id="comment_form">
												...
												<textarea id="comment_content" name="comment_content" style="background-color: #233A50; border: solid 1px #233A50; height: auto; color: #025EA3" cols="30" rows="10" placeholder="Add a public comment"></textarea>
												<li class="btn submit" style="list-style-type: none;"><input type="submit" name="add_comment" value="Submit" class="btn submit" style=" background-color: #DD003F; color: white; height: 37px; width: 100px; border: none; border-radius: 30px;font-family: 'Dosis', sans-serif; font-size: 14px; font-weight: bold; text-transform: uppercase; cursor: pointer; margin-top: 5px; float: right;"></li>
												</form>
						            	...
						            	<div class="col-md-4 col-xs-12 col-sm-12">
						            		...
						            		<div class="sb-it">
						            			<h6>Stars: </h6>
						            			<p><a href="#">Rob
						            			ert Downey Jr,</a> <a href="#">Chris Evans,</a> <a href="#">Mark Ruffalo,</a><a href="#"> Scarlett Johansson</a></p>
						            		</div>
						            		<div class="sb-it">
						            			<h6>Genres:</h6>
