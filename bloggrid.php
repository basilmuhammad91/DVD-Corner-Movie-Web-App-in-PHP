		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="row">
					...
					<!-- FETCHING NEWS GRID DATA FROM DATABASE -->
					<?php
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php?news_id=<?php echo $row[0]?>"><img src="data:image/jpeg;base64,<?php echo base64_encode($row['news_image'])?>" alt=""></a>
