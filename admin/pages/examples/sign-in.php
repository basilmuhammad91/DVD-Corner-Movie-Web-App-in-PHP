...
// If session will exist it will redirect to index page
if(isset($_SESSION['Admin_Email']))
{
    header('location:/DVDCorner/admin/index.php');
}
...
if(isset($_POST['signin']))
{
    ...
    $query = mysqli_query($con,"select * from tbl_admin_registration where tbl_admin_email = '$email' and tbl_admin_password = '$password'");
